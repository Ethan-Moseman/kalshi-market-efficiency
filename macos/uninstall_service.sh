#!/bin/bash
# Remove the three services of this project from macOS.
#
# Use: bash macos/uninstall_service.sh
#
# The command stops the collector, the backfill and the report. It also removes
# the three control files. It does not remove your data.
...
for LABEL in com.ethanmoseman.kalshi-collector \
             ...
             com.ethanmoseman.kalshi-report; do
